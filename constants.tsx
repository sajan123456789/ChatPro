...
export const SYSTEM_INSTRUCTION = "You are ChatPro, a professional AI assistant. You provide concise, high-quality information. Use markdown for code and lists. Be direct and helpful.";
...
export const Icons = {
  ...
  Research: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>
  ),
  Enhance: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3v3m0 12v3M5.6 5.6l2.1 2.1m8.6 8.6l2.1 2.1M3 12h3m12 0h3M5.6 18.4l2.1-2.1m8.6-8.6l2.1-2.1"/></svg>
  ),
  Robot: () => (
  ...
  Lab: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10 2v7.5"/><path d="M14 2v7.5"/><path d="M8.5 2h7"/><path d="M14 11.5a2.5 2.5 0 0 1 0 5L18 22H6l4-5.5a2.5 2.5 0 0 1 0-5z"/></svg>
  ),
  Creative: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m12 19 7-7 3 3-7 7-3-3z"></path><path d="m18 13-1.5-7.5L2 2l3.5 14.5L13 18l5-5z"></path><path d="m2 2 5 5"></path><path d="m8.5 8.5 1.5 1.5"></path></svg>
  ),
  Pin: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="2" x2="12" y2="15"></line><path d="M5 15l1.45-3h11.1L19 15h-14z"></path><line x1="7" y1="15" x2="7" y2="22"></line><line x1="17" y1="15" x2="17" y2="22"></line></svg>
  ),
  PinOff: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-blue-500 fill-blue-500"><line x1="12" y1="2" x2="12" y2="15"></line><path d="M5 15l1.45-3h11.1L19 15h-14z"></path><line x1="7" y1="15" x2="7" y2="22"></line><line x1="17" y1="15" x2="17" y2="22"></line></svg>
  )
};
